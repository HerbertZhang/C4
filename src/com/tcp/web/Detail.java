...
public class Detail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (product != null) {
			...
			out.write("				");
			out.write("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
			out.write("				" + product.getBasePrice() + "");
			out.write("				</td>");
			out.write("			</tr>");
			out.write("			<tr>");
			out.write("				<td class=tablebody1 valign=\"middle\" width=\"25%\" align=\"center\">");
			...
			out.write("				");
			out.write("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
			out.write("				" + product.getProductid() + "");
			out.write("				</td>");
			out.write("			</tr>");
			out.write("			<tr>");
			out.write("				<td class=tablebody1 valign=\"middle\" width=\"25%\" align=\"center\">");
			...
			out.write("				");
			out.write("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
			out.write("				" + product.getCategoryid() + "<br>");
			out.write("				</td>");
			out.write("			</tr>");
			out.write("			<tr>");
			...
			out.write("				");
			out.write("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
			out.write("				" + product.getDescription() + "");
			out.write("				</td>");
			out.write("			</tr>");
			out.write("			<tr>");
			...
			out.write("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
			out.write("				&nbsp");
			out.write("				<img src=\"" + product.getImages() + "\">");
			out.write("				</td>");
			out.write("			</tr>");
			out.write("			");
			out.write("			<tr>");
			out.write("			<td colspan=\"2\" class=tablebody2 valign=\"top\" align=\"center\" width=\"100%\" height=\"32\"> ");
			out.write("				<a href=\"shoppingCart\"><img border=\"0\" src=\"images/buycar.gif\" ></a> ");
			out.write("    		</td>");
			out.write("    		</tr>");
			out.write("			");
			out.write("		</table>");
